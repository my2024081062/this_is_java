package com.example.my_login_spring_security.models.member;

import com.example.my_login_spring_security.common.Util;
...
public class MemberService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		//IMember가 UserDetails를 상속, getUsername()에 getSignId()를 리턴하게 하였으므로 findBySignId(userName)을 리턴해준다.
